...
Lazy-loaded; first call downloads BLIP-base (~440 MB) and pins it on the best
device. Failures degrade gracefully to None — caller falls back to the
synthesized filename text.
"""
